...
// Created: 2/4/2014 5:41:23 PM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcsfa1cmy000004zpu5bf81c3_6n1i";
	this.domain="log.calgary.ca";
	this.timezone=-7;
	this.onsitedoms=(function(){return(window.RegExp?new RegExp(".*\.calgary\.ca|.*\.calgarytransit\.com|.*\.cocnmp\.com|.*\.calgarypolice\.ca|.*\.gov\.calgary\.ab\.ca","i"):"");})();
	this.downloadtypes="xls,xlsx,doc,docx,pdf,txt,csv,ppt,pptx,zip,mpeg,mp3,mp4,avi,wmv,flv,swf,zip";
	this.navigationtag="div,table";
	this.metanames="DC.Creator";
